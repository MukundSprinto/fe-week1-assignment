                            ...
                            {isEditing ? (
                                ...
                                <div className="space-y-6 bg-blue-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="w-full px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-between">
                                            <Link 
                                                href={`/authors/${editedBook ? editedBook.author_id : book.author.id}`}
